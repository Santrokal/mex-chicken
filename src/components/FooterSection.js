const FooterSection = () => {
  return (
    <footer className="bg-background pb-32 lg:pb-0">
      <div className="container">
        ...
        <div className="details py-10 md:py-7 border-b text-white border-green400 space-y-5 sm:space-y-0 flex flex-col sm:flex-row sm:flex-wrap items-center justify-center ">
          <p>Mex Chicken</p>
          <p className="text-red px-1 hidden sm:block">|</p>
          <p className="text-center">Address : XX, XXXX XXXX XXXX, XXXX</p>
          <p className="text-red px-1 hidden sm:block">|</p>
          <p>
            <a href="mailto:" target="_blank" rel="noreferrer">
              Email :<span className="hover:text-red"> </span>
            </a>
          </p>
        </div>
        ...
        <div className="footer-bar-2 text-white py-7 flex flex-col md:flex-row md:justify-between justify-center items-center text-color">
          <div className="flex flex-wrap justify-center sm:justify-start">
            ...
            <p className="text-sm">Roasto &amp; More</p>
            <a
              className="px-1 text-sm hover:text-primary"
              target="_blank"
              rel="noreferrer"
              href="/">
          ...
          <div className="flex pt-2 sm:pt-0 space-x-3 lg:space-x-10 router-active">
            <div>
              <a className="text-sm cursor-pointer" href="/privacy-policy">
                Privacy Policy
              </a>
            </div>
            <div>
